function carregaDicionario() {
  var biografias = {
    bio01: {
      nome: "Angela Davis",
      imagem: "mulheres na história_programaria/angela-davis.png",
      descricao:
    ...
    bio02: {
      ...
      imagem: "mulheres na história_programaria/carolina-de-jesus.png",
      descricao:
    ...
    bio03: {
      ...
      imagem: "mulheres na história_programaria/conceicao-evaristo.png",
      descricao:
    ...
    bio04: {
      nome: "Lélia Gonzalez",
      imagem: "mulheres na história_programaria/lelia-gonzalez.png",
      descricao:
    ...
    bio05: {
      ...
      imagem: "mulheres na história_programaria/marielle-franco.png",
      descricao:
    ...
    bio06: {
      nome: "Rosa Parks",
      imagem: "mulheres na história_programaria/rosa-parks.png",
      descricao:
  ...
  for (var bio in biografias) {
    content.innerHTML += `<div class="card"> <img src="${biografias[bio].imagem}"/> <details> <summary>${biografias[bio].nome}</summary> <p>${biografias[bio].descricao}</p> <blockquote><q>${biografias[bio].citacao}</q></blockquote></details></div>`;
  }
}
